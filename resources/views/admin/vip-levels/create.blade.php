        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-medium mb-4">Create New VIP Level</h3>
                    ...
                    <form action="{{ route('admin.vip-levels.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="deposit_required" class="block mt-1 w-full" type="number" name="deposit_required" :value="old('deposit_required')" step="0.01" min="0" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="reward_multiplier" class="block mt-1 w-full" type="number" name="reward_multiplier" :value="old('reward_multiplier', 1.0)" step="0.01" min="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="daily_tasks_limit" class="block mt-1 w-full" type="number" name="daily_tasks_limit" :value="old('daily_tasks_limit', 10)" min="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="withdrawal_fee_discount" class="block mt-1 w-full" type="number" name="withdrawal_fee_discount" :value="old('withdrawal_fee_discount', 0)" step="0.01" min="0" max="1" required />
